...
const login = async (req, res) => {
    ...
    try {
        ...
        const passwordMatch = await bcrypt.compare(password, user.password); //Comparamos la contraseña que llega con la encriptada
        ...
        res.status(200)     //Enviamos el estado 200
            ...
            .json({ token });   //Enviamos el token en la respuesta
